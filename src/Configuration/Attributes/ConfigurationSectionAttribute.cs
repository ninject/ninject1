...
{
	/// <summary>
	/// Indicates that the type is a configuration section.
	/// </summary>
	...
	public class ConfigurationSectionAttribute : Attribute
	{
		...
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Gets the XML element name of the configuration section.
		/// </summary>
		public string Name
		{
			get { return _name; }
		...
		/// </summary>
		/// <param name="name">The XML element name of the configuration section.</param>
