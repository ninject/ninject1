...
namespace Ninject.Core.Binding.Syntax
{
	...
	public interface IBindingParameterSyntax : IFluentSyntax
	{
		...
		IBindingHeuristicComponentOrParameterSyntax WithConstructorArgument(string name, object value);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Overrides the value for a constructor argument.
		/// </summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithConstructorArgument(string name, Func<IContext, object> valueProvider);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithConstructorArguments(IDictionary arguments);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Overrides the values for a group of constructor arguments.
		/// </summary>
		/// <param name="arguments">An object whose public properties represent the values to inject.</param>
		IBindingHeuristicComponentOrParameterSyntax WithConstructorArguments(object arguments);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		/// <param name="value">The value to inject.</param>
		IBindingHeuristicComponentOrParameterSyntax WithPropertyValue(string name, object value);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Overrides the value for a property injection.
		/// </summary>
		/// <param name="name">The name of the property.</param>
		/// <param name="valueProvider">The callback to trigger to get the value to inject.</param>
		IBindingHeuristicComponentOrParameterSyntax WithPropertyValue(string name, Func<IContext, object> valueProvider);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithPropertyValues(IDictionary values);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Overrides the values for a group of properties.
		/// </summary>
		/// <param name="values">An object whose public properties represent the values to inject.</param>
		IBindingHeuristicComponentOrParameterSyntax WithPropertyValues(object values);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithVariable(string name, object value);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Defines a variable that can be read by the context.
		/// </summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithVariable(string name, Func<IContext, object> valueProvider);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithVariables(IDictionary variables);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Defines a group of variables that can be read by the context.
		/// </summary>
		/// <param name="variables">An object whose public properties will become variables.</param>
		IBindingHeuristicComponentOrParameterSyntax WithVariables(object variables);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithParameter<T>(T parameter) where T : class, IParameter;
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		IBindingHeuristicComponentOrParameterSyntax WithParameters<T>(IEnumerable<T> parameters) where T : class, IParameter;
		/*----------------------------------------------------------------------------------------*/
	}
}