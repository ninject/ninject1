...
{
	/// <summary>
	/// A <see cref="IResolverFactoryPlugin"/> that creates <see cref="KernelResolver"/>s if
	/// the target is an child of <see cref="IKernel"/>.
	/// </summary>
	public class KernelResolverPlugin : IResolverFactoryPlugin
	{
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		{
			return typeof(IKernel).IsAssignableFrom(target.Type);
		}
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		{
			return new KernelResolver(target);
		}
		/*----------------------------------------------------------------------------------------*/
	}
}