...
namespace Ninject.Core.Resolution.Plugins
{
	...
	/// the target is an child of <see cref="IKernelComponent"/>.
	/// </summary>
	public class ComponentResolverPlugin : IResolverFactoryPlugin
	{
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		{
			return typeof(IKernelComponent).IsAssignableFrom(target.Type);
		}
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		{
			return new ComponentResolver(target);
		}
		/*----------------------------------------------------------------------------------------*/
	}
}