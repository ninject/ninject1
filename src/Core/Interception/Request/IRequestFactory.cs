...
{
	/// <summary>
	/// Creates <see cref="IRequest"/>s, which describe method calls.
	/// </summary>
	public interface IRequestFactory : IKernelComponent
	{
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		IRequest Create(IContext context, object target, MethodInfo method, object[] arguments, Type[] genericArguments);
		/*----------------------------------------------------------------------------------------*/
	}
}