...
namespace Ninject.Core.Planning.Strategies
{
	...
	public interface IPlanningStrategy : IStrategy<IPlanner>
	{
		...
		StrategyResult BeforeBuild(IBinding binding, Type type, IActivationPlan plan);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		/// <param name="plan">The activation plan that is being manipulated.</param>
		/// <returns>A value indicating whether to proceed or interrupt the strategy chain.</returns>
		StrategyResult Build(IBinding binding, Type type, IActivationPlan plan);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		/// <param name="plan">The activation plan that is being manipulated.</param>
		/// <returns>A value indicating whether to proceed or interrupt the strategy chain.</returns>
		StrategyResult AfterBuild(IBinding binding, Type type, IActivationPlan plan);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		/// <param name="plan">The activation plan that is being manipulated.</param>
		/// <returns>A value indicating whether to proceed or interrupt the strategy chain.</returns>
		StrategyResult BeforeRelease(IBinding binding, Type type, IActivationPlan plan);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		/// <param name="plan">The activation plan that is being manipulated.</param>
		/// <returns>A value indicating whether to proceed or interrupt the strategy chain.</returns>
		StrategyResult Release(IBinding binding, Type type, IActivationPlan plan);
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		/// Executed before the activation plan is released.
		/// </summary>
		...
		/// <param name="plan">The activation plan that is being manipulated.</param>
		/// <returns>A value indicating whether to proceed or interrupt the strategy chain.</returns>
		StrategyResult AfterRelease(IBinding binding, Type type, IActivationPlan plan);
		/*----------------------------------------------------------------------------------------*/
	}
}