...
namespace Ninject.Conditions.Builders
{
	...
	public class KernelConditionBuilder<TRoot, TPrevious> : ConditionBuilderBase<TRoot, TPrevious, IKernel>
	{
		/*----------------------------------------------------------------------------------------*/
		#region Constructors
		/// <summary>
		...
		public StringConditionBuilder<TRoot, IKernel> Configuration
		{
			get
			{
				return new StringConditionBuilder<TRoot, IKernel>(
					this,
					delegate(IKernel kernel) { return kernel.Configuration; }
					);
			}
		}
		#endregion
