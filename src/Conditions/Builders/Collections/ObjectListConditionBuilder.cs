...
{
	/// <summary>
	/// A condition builder that deals with lists of <see cref="object"/>s. This class
	...
	public class ObjectListConditionBuilder<TRoot, TPrevious, TList> : ListConditionBuilder<TRoot, TPrevious, TList, object, SimpleConditionBuilder<TRoot, TList, object>>
		where TList : IList<object>
	{
		...
		public ObjectListConditionBuilder(Func<TRoot, TList> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public ObjectListConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, TList> converter)
			: base(last, converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		protected override SimpleConditionBuilder<TRoot, TList, object> CreateBuilderForItem(Func<TList, object> converter)
		{
			return new SimpleConditionBuilder<TRoot, TList, object>(this, converter);
		}
		/*----------------------------------------------------------------------------------------*/
	}
}