...
namespace Ninject.Conditions.Builders
{
	...
	public class ProviderConditionBuilder<TRoot, TPrevious> : SimpleConditionBuilder<TRoot, TPrevious, IProvider>
	{
		...
		public ProviderConditionBuilder(Func<TRoot, IProvider> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public ProviderConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, IProvider> converter)
			: base(last, converter)
		{
		}
		#endregion
