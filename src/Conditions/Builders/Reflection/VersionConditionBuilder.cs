...
namespace Ninject.Conditions.Builders
{
	...
	public class VersionConditionBuilder<TRoot, TPrevious> : ComparableConditionBuilder<TRoot, TPrevious, Version>
	{
		...
		public VersionConditionBuilder(Func<TRoot, Version> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public VersionConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, Version> converter)
			: base(last, converter)
		{
		}
		#endregion
