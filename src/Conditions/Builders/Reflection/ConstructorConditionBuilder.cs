...
namespace Ninject.Conditions.Builders
{
	...
	public class ConstructorConditionBuilder<TRoot, TPrevious> : MethodBaseConditionBuilder<TRoot, TPrevious, ConstructorInfo>
	{
		/*----------------------------------------------------------------------------------------*/
		/// <summary>
		...
		public ConstructorConditionBuilder(Func<TRoot, ConstructorInfo> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public ConstructorConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, ConstructorInfo> converter)
			: base(last, converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
