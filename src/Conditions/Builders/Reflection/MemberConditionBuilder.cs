...
namespace Ninject.Conditions.Builders
{
		...
		where TSubject : MemberInfo
	{
		...
		public MemberConditionBuilder(Func<TRoot, TSubject> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public MemberConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, TSubject> converter)
			: base(last, converter)
		{
		}
		#endregion
