...
{
	/// <summary>
	/// A condition builder that deals with <see cref="FieldInfo"/> objects. This class supports
	...
	public class FieldConditionBuilder<TRoot, TPrevious> : MemberConditionBuilder<TRoot, TPrevious, FieldInfo>
	{
		/*----------------------------------------------------------------------------------------*/
		#region Constructors
		/// <summary>
		...
		public FieldConditionBuilder(Func<TRoot, FieldInfo> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public FieldConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, FieldInfo> converter)
			: base(last, converter)
		{
		}
		#endregion
		...
		/// </summary>
		public TypeConditionBuilder<TRoot, FieldInfo> FieldType
		{
			get { return new TypeConditionBuilder<TRoot, FieldInfo>(this, f => f.FieldType); }
		}
		#endregion
		/*----------------------------------------------------------------------------------------*/
	}
