...
namespace Ninject.Conditions.Builders
{
	...
	public class ComparableConditionBuilder<TRoot, TPrevious, TSubject> : SimpleConditionBuilder<TRoot, TPrevious, TSubject>
		where TSubject : IComparable
	{
		...
		public ComparableConditionBuilder(Func<TRoot, TSubject> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public ComparableConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, TSubject> converter)
			: base(last, converter)
		{
		}
		#endregion
