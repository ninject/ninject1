...
namespace Ninject.Conditions.Builders
{
	...
	public class MethodConditionBuilder<TRoot, TPrevious> : MemberConditionBuilder<TRoot, TPrevious, MethodInfo>
	{
		...
		public MethodConditionBuilder(Converter<TRoot, MethodInfo> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public MethodConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Converter<TPrevious, MethodInfo> converter)
			: base(last, converter)
		{
		}
		#endregion
