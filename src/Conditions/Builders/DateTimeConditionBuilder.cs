...
namespace Ninject.Conditions.Builders
{
	...
	public class DateTimeConditionBuilder<TRoot, TPrevious> : ComparableConditionBuilder<TRoot, TPrevious, DateTime>
	{
		...
		public DateTimeConditionBuilder(Func<TRoot, DateTime> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public DateTimeConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, DateTime> converter)
			: base(last, converter)
		{
		}
		#endregion
