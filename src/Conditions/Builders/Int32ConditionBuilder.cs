...
namespace Ninject.Conditions.Builders
{
	...
	public class Int32ConditionBuilder<TRoot, TPrevious> : ComparableConditionBuilder<TRoot, TPrevious, Int32>
	{
		...
		public Int32ConditionBuilder(Func<TRoot, Int32> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public Int32ConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, Int32> converter)
			: base(last, converter)
		{
		}
		#endregion
