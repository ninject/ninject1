...
namespace Ninject.Conditions.Builders
{
	...
	public class RequestConditionBuilder<TRoot, TPrevious> : SimpleConditionBuilder<TRoot, TPrevious, IRequest>
	{
		...
		public RequestConditionBuilder(Func<TRoot, IRequest> converter)
			: base(converter)
		{
		}
		/*----------------------------------------------------------------------------------------*/
		...
		public RequestConditionBuilder(IConditionBuilder<TRoot, TPrevious> last, Func<TPrevious, IRequest> converter)
			: base(last, converter)
		{
		}
		#endregion
