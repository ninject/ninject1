...
using Ninject.Messaging.Properties;
using Ninject.Messaging.Strategies;
#endregion
...
namespace Ninject.Messaging
{
	...
	public class StandardMessageBroker : KernelComponentBase, IMessageBroker
	{
		...
		protected override void OnConnected(EventArgs args)
		{
			...
			planner.Strategies.Append(new EventReflectionStrategy());
		...
		{
			IPlanner planner = Kernel.GetComponent<IPlanner>();
			planner.Strategies.RemoveAll<EventReflectionStrategy>();
